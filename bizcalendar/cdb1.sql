...
INSERT INTO `code_tb` VALUES ('A_001','1','全体',NULL,'ビルディング種類','2020-03-27 20:22:35','2020-03-27 20:22:35'),('A_001','2','チーム',NULL,'ビルディング種類','2020-03-27 20:22:35','2020-03-27 20:22:35'),('A_001','3','ユーザー',NULL,'ビルディング種類','2020-03-27 20:22:35','2020-03-27 20:22:35'),('A_002','0','#f6c2c2','祝日','親リソースID（イベント分類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35'),('A_002','1','#FFD700','イベント','親リソースID（イベント分類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35'),('A_002','2','#66CDAA','タスク','親リソースID（イベント分類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_001','1','#FA8072','チーム会','子リソースID（イベント種類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_001','2','#BC8F8F','目標面談','子リソースID（イベント種類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_001','3','#00BFFF','全体MTG','子リソースID（イベント種類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_001','99','#FFD700','未設定','子リソースID（イベント種類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_002','1','fa fa-calendar-check','重要','イベントアイコン','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_002','2','fa fa-coffee','遊び','イベントアイコン','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_002','3','fa fa-users','会議','イベントアイコン','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_002','4','far fas fa-edit','イベント','イベントアイコン','2020-03-27 20:22:35','2020-03-27 20:22:35'),('E_002','99','0','未設定','イベントアイコン','2020-03-27 20:22:35','2020-03-27 20:22:35'),('T_001','1','未着手',NULL,'タスク状況','2020-03-27 20:22:35','2020-03-27 20:22:35'),('T_001','2','進行中',NULL,'タスク状況','2020-03-27 20:22:35','2020-03-27 20:22:35'),('T_001','3','完了',NULL,'タスク状況','2020-03-27 20:22:35','2020-03-27 20:22:35'),('T_001','4','保留',NULL,'タスク状況','2020-03-27 20:22:35','2020-03-27 20:22:35'),('T_001','99','未設定',NULL,'タスク状況','2020-03-27 20:22:35','2020-03-27 20:22:35'),('T_002','1','#D8BfD8','目標設定','子リソースID（タスク種類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35'),('T_002','99','#66CDAA','未設定','子リソースID（タスク種類（色コード））','2020-03-27 20:22:35','2020-03-27 20:22:35');
...
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='イベントテーブル';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `resource_tb` VALUES (0,1,0,'0','0','2020-03-27 23:01:00','2020-03-27 23:01:00'),(3,2,1,'1','1','2020-03-27 23:01:00','2020-03-27 23:01:00'),(4,3,1,'2',NULL,'2020-05-23 15:22:34','2020-05-23 15:22:34'),(91,3,1,'1','1','2020-05-17 02:20:05','2020-05-17 02:20:05'),(91,3,2,'1','1','2020-05-17 02:20:05','2020-05-17 02:20:05'),(116,3,1,'1','1','2020-05-17 18:04:10','2020-05-17 18:04:10'),(118,1,1,'1','1','2020-05-23 01:27:55','2020-05-23 01:27:55'),(118,3,1,'1','1','2020-05-23 01:27:55','2020-05-23 01:27:55'),(132,3,1,'2',NULL,'2020-05-23 15:16:16','2020-05-23 15:16:16'),(134,3,1,'2',NULL,'2020-05-23 01:23:36','2020-05-23 01:23:36'),(135,2,0,'1',NULL,'2020-05-23 12:46:23','2020-05-23 12:46:23'),(135,2,1,'1',NULL,'2020-05-23 12:46:23','2020-05-23 12:46:23'),(137,2,0,'1',NULL,'2020-05-23 15:15:51','2020-05-23 15:15:51'),(137,3,1,'1',NULL,'2020-05-23 15:15:51','2020-05-23 15:15:51');
...
CREATE TABLE `user_tb` (
  ...
  `birtyday` date DEFAULT NULL COMMENT '誕生日',
...
INSERT INTO `user_tb` VALUES (1,'test1@test.x.xx','test1','テスト　太郎','0','2001-01-01',0,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(2,'test2@test.x.xx','test','テストフラグ差分1','100000000','2001-01-02',1,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(3,'test3@test.x.xx','test','テストフラグ差分2','210000000','2001-01-30',2,1,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(4,'test4@test.x.xx','test','テストフラグ差分3','321000000','2001-01-30',2,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(5,'test5@test.x.xx','test','テストフラグ差分4','432100000','2001-01-30',1,1,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(6,'test6@test.x.xx','test','テストフラグ差分5','543210000','2001-01-30',1,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(7,'test7@test.x.xx','test','テストフラグ差分6','654321000','2001-01-30',2,1,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(8,'test8@test.x.xx','test','テストフラグ差分7','765432100','2001-01-30',2,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(9,'test9@test.x.xx','test','テストフラグ差分8','876543210','2001-01-30',1,1,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(10,'test10@test.x.xx','test','テストフラグ差分9','987654321','2001-01-30',1,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(11,'test11@test.x.xx','test','テストフラグ差分10','0','2001-01-30',2,1,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(12,'test12@test.x.xx','test','テストフラグ差分11','0','2001-01-30',2,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(13,'test13@test.x.xx','test','テストフラグ差分12','0','2001-01-30',1,1,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(14,'test14@test.x.xx','test','テストフラグ差分13','0','2001-01-30',1,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(15,'test15@test.x.xx','test','テストフラグ差分14','0','2001-01-30',2,1,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(16,'test16@test.x.xx','test','テストフラグ差分15','0','2001-01-30',2,0,1,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(17,'test17@test.x.xx','test','テスト無効フラグ','0','2001-01-30',2,0,0,'2018-11-17 13:44:00','2018-11-17 13:44:00'),(18,'-ー_＿@．. ＠ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵabcdefghijklmnopqrst','-ー_＿@．. ＠ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵabcdefghijklmnopqrst','テスト　花子','-ー_＿@．. ＠ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵabcdefghijklmnopqrst','1987-12-30',1,1,1,'2018-11-17 13:44:00','2018-11-17 13:44:00');
...
-- Dump completed on 2020-05-23 16:54:39
